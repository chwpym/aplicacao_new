...
interface FilterSectionTableProps {
  visibleFields: any;
  setVisibleFields: (val: any) => void;
  agrupar: boolean;
  setAgrupar: React.Dispatch<React.SetStateAction<boolean>>;
  getFieldLabel: (field: string) => string;
  copyToClipboard: (mode: "completa" | "intermediaria" | "agrupada" | "tabela" | "tabela_limpa") => void;
  clearResults: () => void;
  saveCurrentAsDefault: () => void;
  restoreDefault: () => void;
}

export const FilterSectionTable: React.FC<FilterSectionTableProps> = ({
  visibleFields,
  setVisibleFields,
  agrupar,
  setAgrupar,
